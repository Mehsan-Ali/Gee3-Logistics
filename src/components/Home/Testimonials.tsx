...
const Testimonials: React.FC = () => {
    ...
    return (
        <main className='px-20 pb-10'>

            {/* ------- Heading Section ------- */}
            <section className='text-center mt-20 mb-10 max-w-2xl mx-auto'>
                <h2 className='text-4xl font-bold'>See what our clients say about our services.</h2>
            </section>
            <div className="embla" ref={emblaRef}>
                        ...
                        testimonilasData.map((testimonial) => (
                            <div className="embla__slide" key={testimonial.id}>
                                <div className="flex items-center justify-center">
                                    <div className="flex-1 flex items-center gap-5 max-w-6xl w-full">
                                        {/* Profile Image Section */}
                                        <div className="relative shrink-0">
                                            <div className="w-72 h-72 rounded-full overflow-hidden bg-sky-400/80">
                                                <img
                                        ...
                                        <div className="flex-1">
                                            <div className="bg-gray-100 px-10 pt-8 pb-4 relative border-l-4 border-orange-600 shadow-md">
                                                {/* Name */}
                                                <h3 className="text-xl border-b border-gray-400 pb-4 font-bold text-gray-900 mb-6">
                                                    {testimonial.name}
                                                </h3>
                ...
                <div className='flex justify-center gap-4 my-8'>
                    <button
                        onClick={scrollPrev}
                        className='w-12 h-12 rounded-full bg-gray-400 text-white flex items-center justify-center hover:bg-gray-700 transition-colors shadow-lg cursor-pointer'
