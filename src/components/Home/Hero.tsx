...
const Hero = () => {
    return (
        <main className='min-h-screen relative'>
            ...
            <section className='absolute -top-10 -z-5 right-1/2 translate-x-1/2 w-full flex justify-center'>
                <img src={HeroImage} alt="" className='max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg animate-float' />
            </section>
            <div className='p-4 sm:p-6 md:p-10 lg:p-20 -z-10 min-h-fit md:h-85 w-full bg-[#f2f2f2] absolute mt-10 flex flex-col md:flex-row items-center md:items-end justify-center md:justify-between gap-4 md:gap-10'>
